...
import codecs
sys.path.append('/data/hugang/JjyCode/GraphSearchNet/graph-based-search/graph_search_nn/src/core/parsers/sourcecode/java')
from build_java_graph import *
RAW_FILE = os.path.join('/data/hugang/JjyCode/GraphSearchNet/CodeSearchNet/python/final/jsonl')
PYTHON_BASE = os.path.join('/data/hugang/JjyCode/GraphSearchNet/CodeSearchNet/python_dedupe_definitions_v2.pkl')
BASE_GRAPH_FILE = os.path.join('/data/hugang/JjyCode/GraphSearchNet/CodeSearchNet/python_base_gz')
